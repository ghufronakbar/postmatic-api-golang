...
type Querier interface {
	...
	GetGeneratedImagePostCaptionsByPostIds(ctx context.Context, postIds []int64) ([]GeneratedImagePostCaption, error)
	GetGeneratedImagePostItemsByPostId(ctx context.Context, generatedImagePostID int64) ([]GeneratedImagePostItem, error)
	GetGeneratedImagePostItemsByPostIds(ctx context.Context, postIds []int64) ([]GeneratedImagePostItem, error)
